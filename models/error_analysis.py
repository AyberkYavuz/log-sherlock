...
distinct passes that this module keeps deliberately separate:
    ...
    * a **deterministic** pass (see :mod:`error_analysis.fingerprint`) that
...
#: provider (see :func:`error_analysis.llm_factory.get_error_analysis_llm`); it
...
class LLMErrorAnalysisResult(BaseModel):
