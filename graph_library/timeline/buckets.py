...
as a :class:`~graph_library.models.timeline.TimelineEvent`.
...
from graph_library.models import ParsedLogEntry, TimelineEvent
...
# ``graph_library.stats.ERROR_LEVELS``: Statistics reports dataset composition and keeps
...
def build_buckets(
    ...
    :func:`~graph_library.timeline.granularity.floor_to_bucket`) and the series runs, with no
