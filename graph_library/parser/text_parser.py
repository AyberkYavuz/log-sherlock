...
registry of focused, declarative patterns (:data:`graph_library.parser.patterns.LINE_PATTERNS`).
Each :class:`~graph_library.parser.patterns.LinePattern` targets a common layout (Spring Boot,
...
New ecosystems are added by extending the registry in :mod:`graph_library.parser.patterns`;
...
from graph_library.models import LogFormat, ParsedLogEntry
