...
of :mod:`graph_library.error_analysis.node`: which model a tier actually resolves to, and how
...
from graph_library.models import AnalysisMode, LLMProvider
...
#: why :func:`~graph_library.error_analysis.node._invoke_with_model_fallback` treats an empty
...
def resolve_model_candidates(provider: str, mode: str) -> list[str]:
    ...
    Args:
        ...
        mode: One of :data:`~graph_library.models.AnalysisMode`.
...
def resolve_model_name(provider: str, mode: str) -> str:
    ...
    Args:
        provider: One of :data:`~graph_library.models.LLMProvider`.
        mode: One of :data:`~graph_library.models.AnalysisMode`.
...
def iter_error_analysis_llms(
    ...
    **overrides: Any,
    ...
    :mod:`graph_library.error_analysis.node`.
